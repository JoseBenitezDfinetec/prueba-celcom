...
class ResConfiTaxesInherit(models.TransientModel):
    ...
    imputacion_iva = fields.Boolean(string='Imputacion del IVA')
    imputacion_ire = fields.Boolean(string='Imputacion del IRE')
    imputacion_irp = fields.Boolean(string='Imputacion del IRP')
    ...
    def get_values(self):
        ...
        res.update(
            ...
            imputacion_iva=config_param_obj.sudo().get_param('imputacion_iva') if config_param_obj.sudo().get_param(
                'imputacion_iva') else False,
            imputacion_ire=config_param_obj.sudo().get_param('imputacion_ire') if config_param_obj.sudo().get_param(
                'imputacion_ire') else False,
            imputacion_irp=config_param_obj.sudo().get_param('imputacion_irp') if config_param_obj.sudo().get_param(
                'imputacion_irp') else False,
        )
        return res
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('imputacion_iva',
                                                         self.imputacion_iva or False)
        self.env['ir.config_parameter'].sudo().set_param('imputacion_ire',
                                                         self.imputacion_ire or False)
        self.env['ir.config_parameter'].sudo().set_param('imputacion_irp',
                                                         self.imputacion_irp or False)
        return res
